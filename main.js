...
/* harmony import */ var _controllTools_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
...
(0,_data_js__WEBPACK_IMPORTED_MODULE_1__.getTask)().forEach((task) => {
    ...
    editTask.forEach((taskList) => {
      (0,_data_js__WEBPACK_IMPORTED_MODULE_1__.getTask)().forEach((task) => {
        if (taskList.dataset.indexNumber === task.index) {
          ...
          localStorage.setItem('Task-list', JSON.stringify((0,_data_js__WEBPACK_IMPORTED_MODULE_1__.getTask)()));
        }
      });
    });
  });
...
window.addEventListener('load', () => {
  (0,_controllTools_js__WEBPACK_IMPORTED_MODULE_2__.updateTask)();
});
...
(0,_controllTools_js__WEBPACK_IMPORTED_MODULE_2__.deleteTask)();
...
task.forEach((item) => {
  item.addEventListener('click', () => {
    if (item.classList.contains('focus')) {
      ...
      (0,_controllTools_js__WEBPACK_IMPORTED_MODULE_2__.deleteOne)(deleteIcon, taskId);
    }
  });
});
...
/* harmony export */ });
/* harmony import */ var _controllTools_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
...
const deleteTask = () => {
  ...
  clearTask.addEventListener('click', () => {
    if ((0,_data_js__WEBPACK_IMPORTED_MODULE_1__.getTask)().length > 0) {
      const filterCompliteTask = (0,_data_js__WEBPACK_IMPORTED_MODULE_1__.getTask)().filter(
...
const deleteOne = (deleteIcon, taskId) => {
  deleteIcon.addEventListener('click', () => {
    const filteredTask = (0,_data_js__WEBPACK_IMPORTED_MODULE_1__.getTask)().filter((task) => task.index !== taskId);
...
const updateTask = () => {
  _index_js__WEBPACK_IMPORTED_MODULE_0__.checkbox.forEach((check) => {
    check.addEventListener('click', () => {
      _index_js__WEBPACK_IMPORTED_MODULE_0__.editTask.forEach((task) => {
        if (check.id === task.dataset.indexNumber) {
          (0,_data_js__WEBPACK_IMPORTED_MODULE_1__.getTask)().forEach((item) => {
