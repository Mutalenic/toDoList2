export const dom = `
<div id="tasks" class="flex-center"><div class="task-list flex-center"><div class="container flex-center"><span class="title">Today's To Do</span> <span class="reload"><i class="fas fa-sync-alt"></i></span></div><div class="container flex-center"><form id="add-task" class="flex-center"><input id="add-task-input" placeholder="Add to your list"> <button type="submit" aria-label="Add new task"><i class="fa fa-plus-circle"></i></button></form></div><ul class="task-list-container"><li class="container task flex-center" draggable="true">
   ...
   </li><li class="container task flex-center" draggable="true">
    <span class="left flex-center">
